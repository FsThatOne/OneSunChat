...
extension AppDelegate{
    private func doAppearanceSetting() {
        // 控制nav背景色
        UINavigationBar.appearance().barTintColor = kBarTintColor
        // 控制nav标题属性
        UINavigationBar.appearance().titleTextAttributes = NSDictionary(object: kWhiteColor, forKey: NSForegroundColorAttributeName) as? [String : AnyObject]
        // 控制nav左返回键
